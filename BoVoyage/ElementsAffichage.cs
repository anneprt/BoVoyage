        ...
        public static readonly List<InformationAffichage> strategieAffichageDossierReservation = new List<InformationAffichage>
            {
                ...
                InformationAffichage.Creer<DossierReservation>(x=>x.NombreParticipant, "Nb participant", 15),
                InformationAffichage.Creer<DossierReservation>(x=>x.PrixParPersonne, "Prix / personne", 15),
                ...
                // Cette ligne ne fonctionne pas avec la dernière version de la DLL.
